...
dataset_loveDA_train = dict(
    type=dataset_type,
    data_prefix=dict(
        img_path=data_root+'Train/Urban/images_png', seg_map_path=data_root+'Train/Urban/masks_png'),
    pipeline=train_pipeline)
dataset_Dalat_train = dict(
    type='LoveDADataset',
    data_prefix=dict(
        img_path='data/dalat/re-train/images/', seg_map_path='data/dalat/re-train/ann_dir/'),
    pipeline=train_pipeline)
